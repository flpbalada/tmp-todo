...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
   ...
   CREATE TYPE "public"."enum_todos_priority" AS ENUM('low', 'medium', 'high');
  CREATE TYPE "public"."enum_todos_category" AS ENUM('personal', 'work', 'shopping', 'health', 'other');
  ...
  CREATE TABLE "todos" (
  	...
  	"priority" "enum_todos_priority" DEFAULT 'medium' NOT NULL,
  	"category" "enum_todos_category" DEFAULT 'other' NOT NULL,
  	"due_date" varchar,
...
export async function down({
  ...
  DROP TYPE "public"."enum_todos_priority";
  DROP TYPE "public"."enum_todos_category";`);
}
